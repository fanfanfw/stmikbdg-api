...
abstract class ArsipDigitalFeatureTestCase extends TestCase
{
    ...
    private function createArsipTables(): void
    {
        ...
        DB::statement('CREATE TABLE arsip_digital.institutional_archives (institutional_archive_id integer primary key autoincrement, unit_id integer not null, category_id integer, title varchar, created_at datetime, updated_at datetime, deleted_at datetime)');
